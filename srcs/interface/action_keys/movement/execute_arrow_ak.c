...
/*   Updated: 2019/04/12 16:49:37 by skuppers         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int8_t			tc_ak_arrow_left(t_interface *itf)
{
	if (validate_interface_content(itf) != 0)
		return (-1);
...
int8_t	tc_ak_arrow_up(t_interface *itf)
{
	(void)itf;
	return (0);
}
...
int8_t		tc_ak_arrow_down(t_interface *itf)
{
	(void)itf;
	return (0);
}
