...
/*   Updated: 2019/02/07 16:29:20 by skuppers         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern t_buffer		*g_vector;
extern t_winsize	*g_ws;

extern	t_termcaps	*g_termcaps;
extern	int (*tc_call[AK_AMOUNT])(t_buffer *vector, t_winsize *ws);
extern	int	ak_keycodes[AK_AMOUNT][READ_SIZE];
extern	t_buffer	*g_clipboard;
...
int				handle_input_key(char c[], t_buffer *v_buffer, t_winsize *ws);

void			vector_rescale(t_buffer *buffer);
size_t			vector_last_char(t_buffer *vector);

void			shift_content_right_once(t_buffer *vect, unsigned int cursor_index);
void			shift_content_left_once(t_buffer *vect, unsigned int cursor_index);
