...
/*   Updated: 2019/04/26 15:20:18 by nrechati         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Combined test										/* Parser : Close pipe[1] */
...
#define EXEC_TEST_Q "ls -l | cat -e <&2 | wc -l"		/*	OK	 */
#define EXEC_TEST_R "ls -l 1>&- | cat -e <&2 | wc -l" 	/*	OK	 */

// Order test											/*	OK	 */
#define EXEC_TEST_S "ls -l . 404 2>&1 > file" 			/* 	TODO */
#define EXEC_TEST_T "ls -l . 404 > file 2>&1"			/* 	TODO */
